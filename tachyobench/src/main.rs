use std::{collections::BTreeMap, ffi::OsString, fs::File, io::Write, num::NonZeroU32};
...
const BENCHES: &[(&str, &str, &[(ExecutorId, fn(NonZeroU32) -> BenchIterator)])] = &[
    ...
    add_test!(funnel, chenal),
    add_test!(funnel, chenal_mpmc),
    add_test!(funnel, chenal_mpmc_racy),
    add_test!(funnel, chenal2),
    add_test!(funnel, chenal2_mpmc),
    add_test!(funnel, chenal2_mpmc_racy),
    add_test!(funnel, chenal_vyukov),
    add_test!(funnel, kanal),
    add_test!(funnel, crossfire),
    ...
    add_test!(pinball, chenal),
    add_test!(pinball, chenal_mpmc),
    add_test!(pinball, chenal_mpmc_racy),
    add_test!(pinball, chenal2),
    add_test!(pinball, chenal2_mpmc),
    add_test!(pinball, chenal2_mpmc_racy),
    add_test!(pinball, chenal_vyukov),
    add_test!(pinball, kanal),
    add_test!(pinball, crossfire),
];
