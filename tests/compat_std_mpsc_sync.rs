...
// TODO uncomment when capacity zero is supported
// #[test]
// fn smoke_threads() {
...
// TODO uncomment when chenal drops messages eagerly on receiver drop (currently deferred until last Arc<Chan> drops)
// #[test]
// fn drop_unreceived() {
